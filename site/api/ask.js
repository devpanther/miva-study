...
export default async function handler(req, res) {
  ...
  const system = [
    ...
    "  - Lead with the answer as one short paragraph. No heading above it.",
    "  - Anything with steps becomes a numbered list, ONE STEP PER LINE. Never run steps together inside a paragraph as \"1. ... 2. ... 3. ...\" — that is the single worst thing you can do to this answer.",
    "  - Code, pseudocode and algorithms go in a fenced block (```), never inline in a sentence. Put the language after the opening fence when you know it.",
    "  - A short formula sits inline in backticks; a derivation of more than one line goes in a fenced block, one step per line.",
    "  - Use a blank line between every block. Bold at most one phrase per answer, for the thing that is actually the point.",
    "  - No headings unless the answer genuinely has two or more distinct parts, and then use ###.",
