...
- **End-on (Tan A, stick east–west) vs broadside-on (Tan B, stick north–south)** — end-on gives B = (μ₀/4π)2Md/(d² − L²)²; broadside-on gives (μ₀/4π)M/(d² + L²)³ᐟ², with a **plus** sign and a **3/2** power. Using the wrong one is the classic full-marks-to-zero slip.
